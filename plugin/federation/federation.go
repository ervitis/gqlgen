...
import (
	...
	"github.com/ervitis/gqlgen/codegen"
	"github.com/ervitis/gqlgen/codegen/config"
	"github.com/ervitis/gqlgen/codegen/templates"
	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/ervitis/gqlgen/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/ervitis/gqlgen/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/ervitis/gqlgen/graphql.Map"},
		},
	}
