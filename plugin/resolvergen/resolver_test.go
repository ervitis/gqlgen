...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/ervitis/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func TestLayoutFollowSchema(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/ervitis/gqlgen/plugin/resolvergen/testdata/followschema/out")
