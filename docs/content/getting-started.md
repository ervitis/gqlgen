...
$ go get github.com/ervitis/gqlgen
```
...
```bash
$ go run github.com/ervitis/gqlgen init
```
...
And run `go run github.com/ervitis/gqlgen generate`.
...
```go
//go:generate go run github.com/ervitis/gqlgen
```
