...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/ervitis/gqlgen/tree/master/example/federation).
...
```bash
go run github.com/ervitis/gqlgen
```
