# gqlgen [![Continuous Integration](https://github.com/ervitis/gqlgen/workflows/Continuous%20Integration/badge.svg)](https://github.com/ervitis/gqlgen/actions) [![Read the Docs](https://badgen.net/badge/docs/available/green)](http://gqlgen.com/)

## What is gqlgen?

[gqlgen](https://github.com/ervitis/gqlgen) is a Go library for building GraphQL servers without any fuss. gqlgen is:
...
If you can't find what your looking for, look at our [examples](https://github.com/ervitis/gqlgen/tree/master/example) for example usage of gqlgen.

## Reporting Issues

If you think you've found a bug, or something isn't behaving the way you think it should, please raise an [issue](https://github.com/ervitis/gqlgen/issues) on GitHub.

## Contributing

Read our [Contribution Guidelines](https://github.com/ervitis/gqlgen/blob/master/CONTRIBUTING.md) for information on how you can help out gqlgen.
...
models:
  ID: # The GraphQL type ID is backed by
    model:
      - github.com/ervitis/gqlgen/graphql.IntID # An go integer
      - github.com/ervitis/gqlgen/graphql.ID # or a go string
```
